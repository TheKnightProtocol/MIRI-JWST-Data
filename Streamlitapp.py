...
# Streamlit Version (Fixed and Enhanced)
    ...
    with col2:
        if generate_btn:
            with st.spinner("🔬 Generating MIRI data and analysis..."):
                data = analyzer.create_simulated_data(
                ...
                st.download_button(
                    label="📥 Download Main Analysis Plot (PNG)",
                    data=fig_to_png_bytes(figures['main_analysis']),
                    file_name="MIRI_JWST_Main_Analysis.png",
                    mime="image/png"
                )
                ...
                st.download_button(
                    ...
                    data=fig_to_png_bytes(figures['spectrum']),
                    file_name="MIRI_JWST_Spectrum.png",
                    mime="image/png"
                )
        else:
            st.info("👈 Adjust parameters and click **Generate Analysis** to begin simulation.")
